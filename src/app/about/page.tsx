                        ...
                        <div className="max-w-xl text-base leading-7 text-white-700 lg:max-w-lg">
                            ...
                            <ol className="relative border-l border-gray-200 dark:border-gray-700">
                                <li className="mb-10 ml-4">
                                    ...
                                    <p className="mb-4 text-base font-normal text-gray-800 dark:text-gray-400">個人でのバグ修正コンペでは1位、AWSを使用したグループハッカソンでは2位を獲得。</p>
                                </li>
                                <li className="mb-10 ml-4">
                                    <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                                    ...
                                    <p className="text-base font-normal text-gray-800 dark:text-gray-400">サーバーサイド、データベース開発を経験。</p>
                                </li>
                                <li className="mb-10 ml-4">
                                    <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                                    ...
                                    <p className="text-base font-normal text-gray-800 dark:text-gray-400">Angular.jsを使用したフロントエンド開発に従事し、新しい機能の追加を行いました。</p>
                                </li>
                                <li className="mb-10 ml-4">
                                    <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                                ...
                                <li className="mb-10 ml-4">
                                    ...
                                    <p className="text-base font-normal text-gray-800 dark:text-gray-400">Amazon S3 等のストレージサービスを中心としたテクニカルサポートに従事しました。</p>
                                </li>
                                <li className="mb-10 ml-4">
                                    <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                                    ...
                                    <p className="text-base font-normal text-gray-800 dark:text-gray-400">Youtube登録者数6万人、Tiktokフォロワー3万人を獲得。</p>
                                </li>
                            </ol>
